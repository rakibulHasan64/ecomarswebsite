          ...
          <nav className="flex-1 mt-4">
            <ul>
              <li className="p-3 hover:bg-[#475569] cursor-pointer">
                <NavLink className="block" to={"/dasbord"}>Dashboards</NavLink>
              </li>
              <li className="p-3 hover:bg-[#475569] cursor-pointer">
                <NavLink className="block" to={"/dasbord/index-category"}>
                  Category
                </NavLink>
              </li>
              <li className="p-3 hover:bg-[#475569] cursor-pointer">
                <NavLink className="block" to={"/dasbord/index-products"}>Products</NavLink>
              </li>
              <li className="p-3 hover:bg-[#475569] cursor-pointer">
                <NavLink className="block" to={"/itemCatagory"}>Users</NavLink>
              </li>
            </ul>
          </nav>
        </aside>
